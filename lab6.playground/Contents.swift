...
//the solution of point 8 in the Homewoork
var arr = ["I love coding","swift is the best language","coding is fun!"]

if  let longest = arr.max(by: {$1.count
    > $0.count}){
    print(longest)
}

//the solution of point 9 and 10 in Homework
        
var arrr = ["I love coding", "swift is the best language","coding is fun!"].map {$0.count}
print(arrr)
for i in arrr{
if (i % 2 != 0){
